...
# Creat a python program to give
...
# 4 pennies
# $1.89
# 7 quarters 1 dimes and 0 nuckels 4 pennies
dollar = 2.96
print(type(dollar))
...
count_of_d = remaining_exchange_after_q // dim_value
print(count_of_d,"dimes")
remaining_exchange_after_d = remaining_exchange_after_q % dim_value
count_of_nikel = remaining_exchange_after_d // nickel_value
print(count_of_nikel,"nickeels")
